...
import { ColoniesDashboard } from '../components/ColoniesDashboard'
import { useColonySummaries } from '../hooks/useColonySummaries'
import { DEFENSES } from '../config/defenses'
import type { GameContext } from '../components/Layout'

export function OverviewPage() {
  const { planet, buildings, weather, events, defenseFleet, refetch, selectPlanet } =
    useOutletContext<GameContext>()
  const { summaries, loading: summariesLoading } = useColonySummaries()
